...
import searchWholeObjByName, { searchWholeObjByNameSimple, searchWholeObjByNameSimpleArray } from "./utils/searchWholeObjByName";
import { XMLParser } from "fast-xml-parser";
import { flatMap, get } from "lodash"; //Here's what should be in the callback:
// {
//   parsedSequence:
//   messages:
//   success:
...
function parseSbolJson(sbolJson, options) {
  ...
  return {
    ...
    features: flatMap(sbolJson.annotation, function (annotation) {
      var feature = get(annotation, "SequenceAnnotation[0]");

      if (feature) {
        var notes = searchWholeObjByNameSimpleArray("@_ns2:about", feature);
        var otherNotes = searchWholeObjByNameSimpleArray("@_ns2:resource", feature);
        var newNotes = {};
        ...
        var featureName = searchWholeObjByNameSimple("name", feature) || searchWholeObjByNameSimple("displayId", feature);
        return {
          name: featureName,
          notes: newNotes,
          type: "misc_feature",
          ...
          start: parseInt(get(feature, "bioStart[0]") - (options.inclusive1BasedStart ? 0 : 1)),
          end: parseInt(get(feature, "bioEnd[0]") - (options.inclusive1BasedEnd ? 0 : 1)),
