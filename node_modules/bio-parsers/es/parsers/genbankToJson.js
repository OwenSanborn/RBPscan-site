...
import validateSequenceArray from "./utils/validateSequenceArray"; // var some = require('lodash/collection/some');
...
function genbankToJson(string, options) {
  ...
  var results = validateSequenceArray(flattenSequenceArray(resultsArray, options), options); // default sequence json has primers at the top level separate from features, e.g. parsedSequence: { primers: [ {}, {} ], features: [ {}, {} ] }
