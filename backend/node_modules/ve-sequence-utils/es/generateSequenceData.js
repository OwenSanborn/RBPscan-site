...
var generateAnnotations = require("./generateAnnotations");
...
module.exports = function generateSequenceData() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      numFeatures = _ref.numFeatures,
      numParts = _ref.numParts,
      numPrimers = _ref.numPrimers,
      numTranslations = _ref.numTranslations;
  ...
  return {
    ...
    translations: isProtein ? undefined : generateAnnotations(numTranslations || 5, 0, sequenceLength - 1, sequenceLength / 3),
    features: generateAnnotations(numFeatures || 10, 0, sequenceLength - 1, sequenceLength / 3),
    primers: isProtein ? undefined : generateAnnotations(numPrimers || 10, 0, sequenceLength - 1, 50),
    parts: generateAnnotations(numParts || 10, 0, sequenceLength - 1, sequenceLength / 3)
  };
};
