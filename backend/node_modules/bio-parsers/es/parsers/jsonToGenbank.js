...
export default function (_serSeq, options) {
  ...
  try {
    ...
    if (serSeq.definition || serSeq.description) {
      lines.push("DEFINITION  " + mangleOrStripUrls(serSeq.definition || serSeq.description, options));
    }
...
function featureToGenbankString(feat, options) {
  ...
  if (feat.color && color.rgb(feat.color).string() !== color.rgb(getFeatureToColorMap({
    includeHidden: true
